...
@Entity
@Table(name="accepted_appointment" , schema = "appointment_db")
public class Appointment 
{
	...
	public String toString() {
		return "Appointment [appointmentId=" + appointmentId + ", reason=" + reason + ", date=" + date + 
			 "patientId=" + patientId + ", physicianEmail=" + physicianEmail + ", submissionDate="
				+ submissionDate + "]";
	}
